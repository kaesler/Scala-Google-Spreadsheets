...
/** A [[CustomFunction10]] represents a Google custom function taking 10 inputs and
  * returning an [[Output]].
  *
  * @param f
...
final class CustomFunction10[-T1, -T2, -T3, -T4, -T5, -T6, -T7, -T8, -T9, -T10, +U](
  ...
  decoder: Decoder[U]
      ...
      (Input, Input, Input, Input, Input, Input, Input, Input, Input, Input) => Output
    ) {
...
object CustomFunction10 {
  ...
  def apply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, U](
    ...
    encoder10: Encoder[T10],
    decoder: Decoder[U]
  ): CustomFunction10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, U] =
    new CustomFunction10(f)

  implicit final class FromFunction10[
    -T1,
    -T2,
    -T3,
    -T4,
