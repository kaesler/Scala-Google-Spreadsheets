...
/** A [[CustomFunction6]] represents a Google custom function taking 6 inputs and
  ...
  *   return type
  */
final class CustomFunction6[-T1, -T2, -T3, -T4, -T5, -T6, +U](
  ...
  encoder6: Encoder[T6],
  decoder: Decoder[U]
) extends ((Input, Input, Input, Input, Input, Input) => CellValueGrid) {
